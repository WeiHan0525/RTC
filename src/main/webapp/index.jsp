        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col-lg-10 col-lg-offset-2">
                    ...
                    <p>參賽證明：經主辦單位審核進入初賽並完繳交企劃書之隊伍，隊伍成員每人皆可獲得參賽證明書乙份。</p>
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="col-lg-4">
                        <table>
                            ...
                            <tr>
                            	<td>
                            		<p style="padding-left: 40px;padding-right: 40px">參賽隊伍通過大賽網站報名註冊，同時須提交用印報名表，每支參賽隊伍，含指導老師，最多不得超過9名成員。</p>
                            	</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <ol>
                                        <li><p>每隊至多2名指導老師，須列入每隊報名入數上限。</p></li>
                                        <li><p>須為大專院校教師。</p></li>
                                    </ol>
                                </td>
                            </tr>
    ...
    <section id="product">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <ol>
                        <li><p>本次大賽參賽作品須為具有一定功能的應用程式，該應用程式應為於iOS系統設計開發，並以蘋果公司的產品及開發工具為基礎。鼓勵參賽隊伍下載 Xcode工具以及使用Swift語言進行開發。</p></li>
                        ...
                        <li><p>首次提交參賽作品時，須繳企劃書，如競賽文件企劃書電子檔所規範；進入決賽的參賽隊伍提交參賽作品時，作品應包含可在移動裝置中運行的應用程式，包含 APP操作過程影片檔、現場簡報檔、 SOURCE CODE及 AP 宣傳文件，進入決賽公布後，參賽隊伍可對作品進行優化，但不能變更作品主題和內容，並根據決賽要求提供最終作品，參賽作品以作品提交截止日期前提交的最後一版為準。</p></li>
                        <li><p>進⼊決賽的參賽隊伍，在準決賽現場前，主辦單位將提供必要的技術支援。</p></li>
                        <li><p>參賽作品若需申請在APP Store上架，請作品所有權人自行按照 APP Store正常流程進行申請，主辦單位將提供與此類申請相關的諮詢。</p></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section id="selection">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <ol>
                        <li><p>參賽作品篩選及初賽階段作品評審，均採取區域之間評委交叉評審的方式(即參賽學校學生的作品，不會由來自其本校的評委進行評審)，決賽階段評委會，將對決賽參賽作品進行現場評分。</p></li>
    ...
    <section id="review">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <ol>
                        <li><p>提交的參賽作品將由大賽評委評審，評審委員將由主辦單位選定，人員包括學校教師（不超過1/3）以 及Apple 、贊助企業人員共同構成（人數總數為奇數）。</p></li>
                    ...
                    <br>
                    <p style="color: #760000">＊注意： APP 參賽作品若無法於比賽期間完成上架者，則酌情減分；初賽評分重點為2~4項⽬。</p>
                    </div>
                </div>
            </div>
        </div>
