            ...
            <div class="row">
                <!--<div class="col-lg-8 col-lg-offset-2">-->
                    ...
                    <table style="width: 100%;"  class="text-center">
                        ...
                        <tr>
                            <td>2017/3/1 ~ 2017/3/31</td>
                            <td>報名日期</td>
                            <td>繳交報名文件</td>
                        </tr>
                        <tr>
                            <td>2017/4/1 ~ 2017/4/30</td>
                            <td>企劃案提交</td>
                            <td>參賽作品交件</td>
                        </tr>
                        <tr>
                            <td>2017/5/1 ~ 2017/5/15</td>
                            <td>初賽評選</td>
                            <td>評選出30隊作品進入決賽</td>
                        </tr><tr>
                            <td>2017/5/15 ~ 2017/6/30</td>
                            <td>實作APP作品提交</td>
                            <td>進入決賽的參賽隊伍對參賽作品進行修改提交</td>
                        </tr><tr>
                            <td>2017/7上旬</td>
                            <td>決賽現場</td>
                            <td>於逢甲大學進行決賽，現場演示、答辯及評選</td>
                        </tr>
                    </table>
                </div>
            </div>
               ...
               <div class="col-lg-10 col-lg-offset-1">
                    <table style="width: 100%"  class="text-center">
                        <tr>
                            ...
                            <th class="text-center">隊數</th>
                            <th class="text-center">獎品</th>
                        </tr>
                        <tr>
                            <td>特獎</td>
                            <td>1隊</td>
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <table style="width: 100%"  class="text-center">
                        <tr>
                            ...
                            <th class="text-center">比重</th>
                        </tr>
                        <tr>
                            <td>新穎性</td>
                            <td class="text-left">獨特的設計理念，是否能夠為用戶「創造全新的體驗」</td>
                            <td>30分</td>
                        </tr>
                        <tr>
                            <td>有效利用 iOS / MacOS /<br>WatchOS / TVOS 平台</td>
                            <td class="text-left">
                                <ol>
                        ...
                        <tr>
                            <td>商業化的可能性</td>
                            <td class="text-left">是否可結合產業應用，使其做商業化的應用，造福更多廣大用戶</td>
                            <td>20分</td>
                        </tr>
                        <tr>
                            <td>技術複雜度</td>
                            <td class="text-left">設計／程式具有一定的技術水準等</td>
                            <td>10分</td>
                        </tr>
                    </table>
                </div>
